...
Test Table 1Row 1 Col1Col2Col3
...
Figure 1 - The behavior pipelineThe numbers in the following list correspond to the numbers in Figure 1.  
...
Figure 2 - Interception using the virtual method interceptorThe numbers in the following list correspond to the numbers in Figure 2.  
...
Using policies with matching rules such as those shown in the previous example means that you can apply and manage the policies when you configure your container. You can define the policies either in code, as shown in the example, or in a configuration file in a similar way to that described in the section â€œDesign Time Configurationâ€ earlier in this chapter.  
